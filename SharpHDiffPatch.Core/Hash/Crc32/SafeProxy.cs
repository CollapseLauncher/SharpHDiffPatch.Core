...
namespace SharpHDiffPatch.Core.Hash.Crc32
{
    internal class SafeProxy
    {
        ...
        public uint Append(uint crc, ReadOnlySpan<byte> input)
        {
            ...
            {
                uint a = table[3 * 256 + input[12]]
                         ^ table[2 * 256 + input[13]]
                         ^ table[1 * 256 + input[14]]
                         ^ table[0 * 256 + input[15]];

                uint b = table[7 * 256 + input[8]]
                         ^ table[6 * 256 + input[9]]
                         ^ table[5 * 256 + input[10]]
                         ^ table[4 * 256 + input[11]];

                uint c = table[11 * 256 + input[4]]
                         ^ table[10 * 256 + input[5]]
                         ^ table[9 * 256 + input[6]]
                         ^ table[8 * 256 + input[7]];

                uint d = table[15 * 256 + ((byte)crcLocal ^ input[0])]
