using System;
using static ManagedLzma.LZMA.Master.LZMA;
...
namespace ManagedLzma.LZMA.Master
{
    ...
    internal sealed class CLzmaProps
    {
        ...
        internal CLzmaProps() { }
        internal CLzmaProps(CLzmaProps other)
        {
            this.mLC = other.mLC;
            this.mLP = other.mLP;
            this.mPB = other.mPB;
        ...
        */
        ...
        internal SRes LzmaProps_Decode(P<byte> data, uint size)
        {
    ...
    public sealed class CLzmaDec
    {
        ...
        */
        ...
        internal SRes LzmaDec_AllocateProbs(P<byte> props, uint propsSize, ISzAlloc alloc)
        {
            SRes res;
        ...
        internal void LzmaDec_FreeProbs(ISzAlloc alloc)
        {
            alloc.FreeUInt16(alloc, mProbs);
            mProbs = null;
        }

        internal SRes LzmaDec_Allocate(P<byte> props, uint propsSize, ISzAlloc alloc)
        {
            CLzmaProps propNew = new CLzmaProps();
        ...
        internal void LzmaDec_Free(ISzAlloc alloc)
        {
            LzmaDec_FreeProbs(alloc);
            LzmaDec_FreeDict(alloc);
        }
        ...
        */
        ...
        internal SRes LzmaDec_DecodeToDic(long dicLimit, P<byte> src, ref long srcLen, ELzmaFinishMode finishMode, out ELzmaStatus status)
        {
            long inSize = srcLen;
            srcLen = 0;
        ...
        */
        ...
        internal SRes LzmaDec_DecodeToBuf(P<byte> dest, ref long destLen, P<byte> src, ref long srcLen, ELzmaFinishMode finishMode, out ELzmaStatus status)
        {
        ...
        */
        ...
        internal static SRes LzmaDecode(P<byte> dest, ref long destLen, P<byte> src, ref long srcLen, P<byte> propData, uint propSize, ELzmaFinishMode finishMode, out ELzmaStatus status, ISzAlloc alloc)
        {
            long outSize = destLen;
            long inSize = srcLen;
            destLen = 0;
